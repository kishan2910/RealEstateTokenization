      ...
      <div class="col-12 justify-content-center d-flex flex-row pt-5">
        <div id="signup-div" class="flex-item border">        
          ...
          <form @submit="signup" class="pt-4 pl-4 pr-4">
            ...
            <p> We will forward you to KYC verification - Make sure you are in a quite and bright room for further identifcation.</p>
            ...
            <small class="form-text text-muted">
              ...
              By signing up, you acknowledge that you have read and understood, and agree to Terms and Conditions and Privacy Policy.</small>
